...
public class FrmAnalizador extends javax.swing.JFrame {
    ...
    private void analizarLexico() throws IOException {
        ...
        Lexico lexicos;
        lexicos = new Lexico(new StringReader(expr));
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Modulo:
                    ...
                    break;
                case Op_logico:
                    resultado += "  <Op_logico>\t\t" + lexicos.lexemas + "\n";
                    break;
                case Op_relacional:
                    resultado += "  <Op_relacional>\t" + lexicos.lexemas + "\n";
                    break;
                case Op_atribucion:
                    resultado += "  <Op_atribucion>\t\t" + lexicos.lexemas + "\n";
                    break;
                case Op_incremento:
                    resultado += "  <Op_incremento>\t\t" + lexicos.lexemas + "\n";
                    break;
                case Op_true:
                    resultado += "  <Op_booleano>\t\t" + lexicos.lexemas + "\n";
                    break;
                case Register:
                ...
                case Cout:
                    ...
                    break;
                case Printf:
                    resultado += "  <Reservada Prinf>\t" + lexicos.lexemas + "\n";
                    break;
                case Scanf:
                ...
                case Std:
                    ...
                    break;
                case String:
                    resultado += "  <Reservada String>\t" + lexicos.lexemas + "\n";
                    break;
                case Igual:
